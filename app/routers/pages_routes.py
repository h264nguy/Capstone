...
def dashboard(request: Request):
    ...
    <body><div class='page'>
      ...
      <div class='grid cards'>
        ...
        <div class='card'>
          <h2>CANVA</h2>
          <div class='small'>Open your Canva page.</div>
          <div class='btnrow'>
  ...
  drinks.forEach(d => {
    ...
    card.innerHTML = `
      ...
      <div class='btnrow' style='margin-top:12px'>
        <a class='secondary' href="/drink/${d.id}">Open</a>
        <button class='secondary' onclick="addToCart('${d.id}','${d.name.replace(/'/g, "\\'")}',${cal})">Add</button>
...
async function checkout(){
  ...
  cart = {};
  renderCart();
  status.innerText = data.esp ? "Order sent to machine " : "Order saved  (machine offline)";
...
# ✅ FIXED HISTORY: read from /api/history so it ALWAYS matches what the server saved
